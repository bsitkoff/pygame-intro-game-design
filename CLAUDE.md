...
**Student files**: `explore.py` (read-only example), `images/`
**Guide pages**: Game Changineer → Explore a Game → File Structure → Make It Yours → Think and Extend
**Note**: `Page-1-5e01.md` is an orphan page (not in index.json) — left over from early development.
