...
Focus on effort and engagement, not correctness."""
        ...
        # Look for GENUINE or NON_ATTEMPT anywhere in the response
...
def main():
    ...
    # If LLM is requested and we have a question context, use it
    if args['use_llm'] and args['question_context']:
        ...
        # No LLM - just accept any non-empty response
